...
//          */
//         Sacado sacado = new Sacado(boleto.getCliente().getNome(), 
//        		 boleto.getCliente().getCpfCnpj());
//
//         // Informando o endereço do sacado. / Cliente
//         Endereco enderecoSac = new Endereco();
//         enderecoSac.setUF(UnidadeFederativa.valueOfSigla(boleto.getCliente().getUf()));
//         enderecoSac.setLocalidade(boleto.getCliente().getEndereco());
//         enderecoSac.setCep(new CEP(boleto.getCliente().getCep()));
//         enderecoSac.setBairro(boleto.getCliente().getCep());
//         enderecoSac.setLogradouro("");
//         enderecoSac.setNumero(boleto.getCliente().getNumeroEndereco());
//         sacado.addEndereco(enderecoSac);
//
//         
//         
//         ContaBancaria contaBancaria = new ContaBancaria(
//        		 getBanco(boleto.getCliente().getContaCorrenteBoleto().getBanco()).create());
//         
//         
//         contaBancaria.setNumeroDaConta(new NumeroDaConta(
//        		 Integer.valueOf(boleto.getCliente().getContaCorrenteBoleto().getNumeroContaCorrente()),
//        		 boleto.getCliente().getContaCorrenteBoleto().getDigitoContaCorrente()));
//         
//         contaBancaria.setCarteira(new Carteira(Integer.valueOf(boleto.getCliente().getContaCorrenteBoleto().getNumeroCarteira())));
//         
//         contaBancaria.setAgencia(new Agencia(Integer.valueOf(boleto.getCliente().getContaCorrenteBoleto().getNumeroAgencia())));
////         
//         Titulo titulo = new Titulo(contaBancaria, sacado, cedente);
//         titulo.setNumeroDoDocumento("123456");
//         titulo.setNossoNumero(boleto.getCliente().getContaCorrenteBoleto().getNossoNumero());
//         titulo.setDigitoDoNossoNumero(boleto.getCliente().getContaCorrenteBoleto().getDigitoNossoNumero());
...
//         String nomeArquivo = boleto.getCliente().getNome() + boleto.getDataVencimento().toString()+".pdf";
