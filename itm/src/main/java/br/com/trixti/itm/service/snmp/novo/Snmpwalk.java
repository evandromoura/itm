package br.com.trixti.itm.service.snmp.novo;
...
public class Snmpwalk {
    ...
    public static void main(String[] args) {
        try{
            ...
            args = new String[]{"-c"," communityName"," -p","portNumber","-v", "1", "177.190.167.78" ,"1.3.6.1.2.1.2.2.1.2"};
