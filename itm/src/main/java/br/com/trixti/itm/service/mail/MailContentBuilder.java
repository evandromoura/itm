...
public class MailContentBuilder {
     ...
     */
    public Multipart build(String messageText, String messageHtml, List<URL> messageHtmlInline, List<File> attachments) throws MessagingException {
    ...
    private void addAttachments(Multipart parent, List<File> attachments) throws MessagingException {
        if (attachments != null){
            for (File attachment : attachments){
                final MimeBodyPart mbpAttachment = new MimeBodyPart();
                DataSource htmlPartImgDs = new FileDataSource(attachment);
